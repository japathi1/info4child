               ...
               <div class="span12">
                  <div class="widget">
                        ...
                        <div class="widget-body">
								...
								<div class="form-horizontal">
									<div class="control-group">
										...
										<div class="controls">
										  ...
										  <input name="TeacherFirstName" class="input-xlarge focused" id="focusedInput2" type="text" value="<?php echo $TeacherFirstName; ?>">
										</div>
									</div>
									<div class="control-group">
							...
							<form name="EditWorkExperience" class="form-horizontal" action="../configs/teacher-edit-profile-agent.php" method="post" onSubmit="return validEditWorkExperience();">
								<div class="form-horizontal">
									<div class="control-group">
                            ...
                            <hr>
							<form name="EditAddressInformation" class="form-horizontal" action="../configs/teacher-edit-profile-agent.php" method="post" onSubmit="return validEditAddressInformation();">
								<div class="form-horizontal">
							...
							<div class="widget-body form">
								...
								<form name="ChangeProfilePicture" enctype="multipart/form-data" class="form-horizontal" action="../configs/teacher-edit-profile-agent.php" method="post" onSubmit="return validChangeProfilePicture();">
                            ...
                            <hr>
							<form name="ChangeYourPassword" class="form-horizontal" action="../configs/teacher-edit-profile-agent.php" method="post" onSubmit="return validChangeYourPassword();">
								<div class="form-horizontal">
								<div class="control-group">
