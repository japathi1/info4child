  ...
  <div class="row-fluid">
    ...
    <div id="content" class="span10">
            ...
            <table class="table table-condensed">
                              ...
                              <td>&nbsp; </td>
								...
								<tr>
									...
									<td class="center" style="border:none"><strong>Sibling:</strong></td>
								                        
								</tr>
								<tr>
								
									<td class="center" style="border:none"><div class="control-group">
								
								<div class="controls">
								  <select id="selectError3" class="span12">
									<option>Img will come</option>
									<option><a href="#">View Profile</a></option>
								...
								<tr>
									...
									<td class="center" style="border:none"><strong>Class Teacher</strong></td>
		...
		<div class="row-fluid sortable ui-sortable">
				<div class="box span3">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-filter"></i>School Result</h2>
						<div class="box-icon">
				...
				<div class="box span3">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-eye-close"></i> View Assignment </h2>
						<div class="box-icon">
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
						</div>
					</div>
				...
				<div class="box span3">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-envelope"></i> New Message</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
						</div>
					</div>
				...
				<div class="box span3">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-bullhorn"></i> Notice Board</h2>
					</div>
					<div class="box-content">
                  	<div class="row-fluid">
                        <div class="span4"><h6>span 4</h6></div>
      ...
      <div class="row-fluid sortable">
        <div class="box span4">
          <div class="box-header well" data-original-title>
            <h2><i class="icon-flag"></i> EC Exam Notification</h2>
        ...
        <div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list-alt"></i>Attandace Record</h2>
						<div class="box-icon">
	  ...
	  <div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-facetime-video"></i> School Photo Gallery</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
