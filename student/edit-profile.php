                        ...
                        <div class="widget-body">
							...
							<form name="ChangeYourPassword" class="form-horizontal" action="../configs/student-edit-profile-agent.php" method="post" onSubmit="return validChangeYourPassword();">
								...
								<div class="control-group">
									...
									<div class="controls">
									  <input name="password" class="input-xlarge focused" id="focusedInput" data-rel="popover" data-content="Password Should be Alphanumeric Contents Only" title="Password Hint's" type="Password">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="focusedInput">Confirm New Password:</label>
									<div class="controls">
									  <input name="repassword" class="input-xlarge focused" id="focusedInput" type="password">
									</div>
								</div>
								<div class="form-actions">
									<button type="submit" class="btn btn-primary">Save</button>
